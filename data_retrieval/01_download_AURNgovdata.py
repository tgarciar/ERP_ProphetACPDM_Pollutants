...
### THIS SCRIPT WAS CREATED BY PROFESSOR DAVID TOPPING, UNIVERSITY OF MANCHESTER.
### IT WILL BE USED TO DOWNLOAD AURN DATA FROM THE DEFRA WEBSITE.
### THIS SCRIPT CAN ALSO BE USED TO PLOT DIURNAL PROFILES BUT BY DEFAULT, FOR THIS RESEARCH, THIS FUNCTIONALITY IS OFF.
### DEFAULTS CITIES DATASET RETRIEVE ARE: MANCHESTER, SALFORD AND BURY DURING THE YEARS 2016 - 2023.
### PLEASE READ LICENSES BEFORE DOWNLOADING THE DATA!


##########################################################################################
#                                                                                        #
#    Scripts to download AURN air quality data from uk-air.defra.gov.uk                  #
...
download_path = "datasets/AURN_data"
...
meata_data_filename = 'datasets/AURN_data/AURN_metadata.RData'
...
if os.path.isfile(meata_data_filename) is True:
    ...
    wget.download(meta_data_url, out=download_path)
...
plot_diurnal_comparison = False

site_data_dict=dict()
site_data_dict_name=dict()
if manual_selection is True:
    list_authorities = ['Manchester','Salford','Bury']
else:
    #pdb.set_trace()
